...
Internal actors are typically trusted by an org, providing them an easier ability to gain access to resources as they have ID badges, access to both the physical and wireless network, and other resources.

External actors only have the advantage of being anonymous, however, they are only able to gain access using attacks. These actors face many risks and challenges compared to internal actors.
...
Intel gathered from publicly available sources like public records & social media platforms.
